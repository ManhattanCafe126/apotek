...
class ScanBarcodeSearchPage extends StatefulWidget {
  const ScanBarcodeSearchPage({super.key});

  @override
  State<ScanBarcodeSearchPage> createState() => _ScanBarcodeSearchPageState();
}

class _ScanBarcodeSearchPageState extends State<ScanBarcodeSearchPage> {
  String _scannedBarcode = '';
  bool _isScanning = false;
  ModelObat? _foundDrug;
  ...
  Future<void> _searchObatByBarcode(String searchQuery) async {
    setState(() {
      _errorMessage = null;
      _foundDrug = null;
    });
    ...
    try {
      ...
      final drug = ModelObat.fromJson(data);
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: _searchManualBarcode.isEmpty
                    ? null
                    : () => _searchObatByBarcode(_searchManualBarcode),
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600,
                                      color: _isExpired(_foundDrug!.expDate)
                                          ? Colors.red
                                          : Colors.black87,
                                    ),
                                  ),
                                  if (_isExpired(_foundDrug!.expDate))
                                    const Padding(
                        ...
                        _buildDetailRow(
                          ...
                          label: 'Stok',
                          value: '${_foundDrug!.formattedStok} unit',
                          valueColor: _foundDrug!.totalStok == 0
                              ? Colors.red
                              : Colors.black87,
                        ),
                      ],
