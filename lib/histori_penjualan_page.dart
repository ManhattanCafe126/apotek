...
class TampilanRiwayatPenjualan extends StatefulWidget {
  const TampilanRiwayatPenjualan({super.key});

  @override
  State<TampilanRiwayatPenjualan> createState() => _TampilanRiwayatPenjualanState();
}

class _TampilanRiwayatPenjualanState extends State<TampilanRiwayatPenjualan> {
        ...
        children: [
          ...
          Padding(
            ...
            child: StreamBuilder<QuerySnapshot>(
              stream: LayananFirestore.alirkanRiwayatPenjualan(),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                return tampilkanDaftarRiwayatPenjualan(filteredDocs);
              },
            ),
          ),
        ],
  ...
  Widget tampilkanDaftarRiwayatPenjualan(List<DocumentSnapshot> filteredDocs) {
